...
class T5Classifier:
    ...
    def preprocess_function(self, examples):
        try:
            ...
            model_inputs = self.tokenizer(inputs, max_length=self.config['max_length'], padding=False, truncation=True)
            labels = self.tokenizer(targets, max_length=16, padding=False, truncation=True)
